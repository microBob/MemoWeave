...
extension BlockCollectionQueryWhereSort
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterWhere> anyId() =>
      QueryBuilder.apply(
          this, (query) => query.addWhereClause(const IdWhereClause.any()));
}
...
extension BlockCollectionQueryWhere
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterWhereClause> idEqualTo(
      ...
      QueryBuilder.apply(
          this,
          (query) => query.addWhereClause(IdWhereClause.between(
                lower: id,
                upper: id,
              )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterWhereClause>
      idGreaterThan(Id id, {bool include = false}) => QueryBuilder.apply(
          this,
          (query) => query.addWhereClause(
...
extension BlockCollectionQueryFilter
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      blockStyleEqualTo(BlockStyle value) => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
    ...
    bool include = false,
          ...
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.greaterThan(
                    include: include,
                    property: r'blockStyle',
                    value: value,
                  )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
    ...
    bool include = false,
          ...
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.lessThan(
                    include: include,
                    property: r'blockStyle',
                    value: value,
                  )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
    ...
    bool includeUpper = true,
          ...
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.between(
                    property: r'blockStyle',
                    lower: lower,
                    includeLower: includeLower,
                    upper: upper,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      childIdsElementEqualTo(int value) => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'childIds',
                value: value,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      childIdsLengthEqualTo(int length) => QueryBuilder.apply(
          this,
          (query) => query.listLength(
                r'childIds',
                length,
                true,
                length,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      childIdsIsEmpty() => QueryBuilder.apply(
          this,
          (query) => query.listLength(
                r'childIds',
                0,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      childIdsIsNotEmpty() => QueryBuilder.apply(
          this,
          (query) => query.listLength(
                r'childIds',
                0,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      hasThreadAsParentEqualTo(bool value) => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      idEqualTo(Id value) => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'id',
                value: value,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      inlineStylesLengthEqualTo(int length) => QueryBuilder.apply(
          this,
          (query) => query.listLength(
                r'inlineStyles',
                length,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      inlineStylesIsEmpty() => QueryBuilder.apply(
          this,
          (query) => query.listLength(
                r'inlineStyles',
                0,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      inlineStylesIsNotEmpty() => QueryBuilder.apply(
          this,
          (query) => query.listLength(
                r'inlineStyles',
                0,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      parentEqualTo(int value) => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'parent',
                value: value,
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
    ...
    bool caseSensitive = true,
          ...
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.startsWith(
                    property: r'text',
                    value: value,
                    caseSensitive: caseSensitive,
                  )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
    ...
    bool caseSensitive = true,
          ...
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.endsWith(
                    property: r'text',
                    value: value,
                    caseSensitive: caseSensitive,
                  )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      textContains(String value, {bool caseSensitive = true}) =>
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.contains(
                    property: r'text',
                    value: value,
                    caseSensitive: caseSensitive,
                  )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      textMatches(String pattern, {bool caseSensitive = true}) =>
          QueryBuilder.apply(
              this,
              (query) => query.addFilterCondition(FilterCondition.matches(
                    property: r'text',
                    wildcard: pattern,
                    caseSensitive: caseSensitive,
                  )));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      textIsEmpty() => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'text',
                value: '',
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      textIsNotEmpty() => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.greaterThan(
                property: r'text',
                value: '',
...
extension BlockCollectionQueryObject
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterFilterCondition>
      inlineStylesElement(FilterQuery<StyleNode> q) =>
          QueryBuilder.apply(this, (query) => query.object(q, r'inlineStyles'));
}
...
extension BlockCollectionQuerySortBy
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      sortByBlockStyle() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'blockStyle', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      sortByBlockStyleDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'blockStyle', Sort.desc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      sortByHasThreadAsParent() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'hasThreadAsParent', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      sortByHasThreadAsParentDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'hasThreadAsParent', Sort.desc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy> sortByParent() =>
      QueryBuilder.apply(this, (query) => query.addSortBy(r'parent', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      sortByParentDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'parent', Sort.desc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy> sortByText() =>
      QueryBuilder.apply(this, (query) => query.addSortBy(r'text', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      sortByTextDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'text', Sort.desc));
}

extension BlockCollectionQuerySortThenBy
    on QueryBuilder<BlockCollection, BlockCollection, QSortThenBy> {
  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      thenByBlockStyle() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'blockStyle', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      thenByBlockStyleDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'blockStyle', Sort.desc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      thenByHasThreadAsParent() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'hasThreadAsParent', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      thenByHasThreadAsParentDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'hasThreadAsParent', Sort.desc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy> thenById() =>
      QueryBuilder.apply(this, (query) => query.addSortBy(r'id', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy> thenByIdDesc() =>
      QueryBuilder.apply(this, (query) => query.addSortBy(r'id', Sort.desc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy> thenByParent() =>
      QueryBuilder.apply(this, (query) => query.addSortBy(r'parent', Sort.asc));

  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      thenByParentDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'parent', Sort.desc));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QAfterSortBy>
      thenByTextDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'text', Sort.desc));
}
...
extension BlockCollectionQueryWhereDistinct
  ...
  QueryBuilder<BlockCollection, BlockCollection, QDistinct>
      distinctByBlockStyle() => QueryBuilder.apply(
          this, (query) => query.addDistinctBy(r'blockStyle'));

  QueryBuilder<BlockCollection, BlockCollection, QDistinct>
      distinctByChildIds() =>
          QueryBuilder.apply(this, (query) => query.addDistinctBy(r'childIds'));

  QueryBuilder<BlockCollection, BlockCollection, QDistinct>
      distinctByHasThreadAsParent() => QueryBuilder.apply(
          this, (query) => query.addDistinctBy(r'hasThreadAsParent'));

  QueryBuilder<BlockCollection, BlockCollection, QDistinct>
      distinctByParent() =>
          QueryBuilder.apply(this, (query) => query.addDistinctBy(r'parent'));
  ...
  QueryBuilder<BlockCollection, BlockCollection, QDistinct> distinctByText(
      ...
      QueryBuilder.apply(
          this,
          (query) =>
              query.addDistinctBy(r'text', caseSensitive: caseSensitive));
}
...
extension BlockCollectionQueryProperty
  ...
  QueryBuilder<BlockCollection, int, QQueryOperations> idProperty() =>
      QueryBuilder.apply(this, (query) => query.addPropertyName(r'id'));

  QueryBuilder<BlockCollection, BlockStyle, QQueryOperations>
      blockStyleProperty() => QueryBuilder.apply(
          this, (query) => query.addPropertyName(r'blockStyle'));

  QueryBuilder<BlockCollection, List<int>, QQueryOperations>
      childIdsProperty() => QueryBuilder.apply(
          this, (query) => query.addPropertyName(r'childIds'));

  QueryBuilder<BlockCollection, bool, QQueryOperations>
      hasThreadAsParentProperty() => QueryBuilder.apply(
          this, (query) => query.addPropertyName(r'hasThreadAsParent'));

  QueryBuilder<BlockCollection, List<StyleNode>, QQueryOperations>
      inlineStylesProperty() => QueryBuilder.apply(
          this, (query) => query.addPropertyName(r'inlineStyles'));

  QueryBuilder<BlockCollection, int, QQueryOperations> parentProperty() =>
      QueryBuilder.apply(this, (query) => query.addPropertyName(r'parent'));

  QueryBuilder<BlockCollection, String, QQueryOperations> textProperty() =>
      QueryBuilder.apply(this, (query) => query.addPropertyName(r'text'));
}
