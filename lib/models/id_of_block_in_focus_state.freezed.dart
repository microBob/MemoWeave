...
part of 'id_of_block_in_focus_state.dart';
...
mixin _$IdOfBlockInFocusState {
  ...
  @JsonKey(ignore: true)
  $IdOfBlockInFocusStateCopyWith<IdOfBlockInFocusState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $IdOfBlockInFocusStateCopyWith<$Res> {
...
/// @nodoc
class _$IdOfBlockInFocusStateCopyWithImpl<$Res,
        $Val extends IdOfBlockInFocusState>
    implements $IdOfBlockInFocusStateCopyWith<$Res> {
  _$IdOfBlockInFocusStateCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      blockId: null == blockId
          ...
          : blockId // ignore: cast_nullable_to_non_nullable
              as int,
      setFromTraversal: null == setFromTraversal
          ? _value.setFromTraversal
          : setFromTraversal // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$_IdOfBlockInFocusState implements _IdOfBlockInFocusState {
  ...
  final int blockId;
  @override
  final bool setFromTraversal;

  @override
  String toString() {
    return 'IdOfBlockInFocusState(blockId: $blockId, setFromTraversal: $setFromTraversal)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, blockId, setFromTraversal);
