...
List<IsarLinkBase<dynamic>> _threadCollectionGetLinks(
        ThreadCollection object) =>
    [];
...
extension ThreadCollectionQueryWhere
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterWhereClause>
      idLessThan(Id id, {bool include = false}) => QueryBuilder.apply(
          this,
          (query) => query.addWhereClause(
...
extension ThreadCollectionQueryFilter
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterFilterCondition>
      dateTimeEqualTo(DateTime value) => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'dateTime',
                value: value,
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterFilterCondition>
      spoolIsEmpty() => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'spool',
                value: '',
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterFilterCondition>
      spoolIsNotEmpty() => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.greaterThan(
                property: r'spool',
                value: '',
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterFilterCondition>
      subjectIsEmpty() => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.equalTo(
                property: r'subject',
                value: '',
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterFilterCondition>
      subjectIsNotEmpty() => QueryBuilder.apply(
          this,
          (query) => query.addFilterCondition(FilterCondition.greaterThan(
                property: r'subject',
                value: '',
...
extension ThreadCollectionQuerySortBy
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      sortByDateTime() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'dateTime', Sort.asc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      sortByDateTimeDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'dateTime', Sort.desc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      sortBySpool() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'spool', Sort.asc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      sortBySpoolDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'spool', Sort.desc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      sortBySubject() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'subject', Sort.asc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      sortBySubjectDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'subject', Sort.desc));
}

extension ThreadCollectionQuerySortThenBy
    on QueryBuilder<ThreadCollection, ThreadCollection, QSortThenBy> {
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenByDateTime() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'dateTime', Sort.asc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenByDateTimeDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'dateTime', Sort.desc));
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenByIdDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'id', Sort.desc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenBySpool() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'spool', Sort.asc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenBySpoolDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'spool', Sort.desc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenBySubject() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'subject', Sort.asc));

  QueryBuilder<ThreadCollection, ThreadCollection, QAfterSortBy>
      thenBySubjectDesc() => QueryBuilder.apply(
          this, (query) => query.addSortBy(r'subject', Sort.desc));
}
...
extension ThreadCollectionQueryWhereDistinct
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QDistinct>
      distinctByDateTime() =>
          QueryBuilder.apply(this, (query) => query.addDistinctBy(r'dateTime'));
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QDistinct> distinctBySpool(
      ...
      QueryBuilder.apply(
          this,
          (query) =>
              query.addDistinctBy(r'spool', caseSensitive: caseSensitive));
  ...
  QueryBuilder<ThreadCollection, ThreadCollection, QDistinct> distinctBySubject(
      ...
      QueryBuilder.apply(
          this,
          (query) =>
              query.addDistinctBy(r'subject', caseSensitive: caseSensitive));
}
...
extension ThreadCollectionQueryProperty
  ...
  QueryBuilder<ThreadCollection, DateTime, QQueryOperations>
      dateTimeProperty() => QueryBuilder.apply(
          this, (query) => query.addPropertyName(r'dateTime'));

  QueryBuilder<ThreadCollection, String, QQueryOperations> spoolProperty() =>
      QueryBuilder.apply(this, (query) => query.addPropertyName(r'spool'));

  QueryBuilder<ThreadCollection, String, QQueryOperations> subjectProperty() =>
      QueryBuilder.apply(this, (query) => query.addPropertyName(r'subject'));
}
